...
from data_preprocessing_waveform import pre_emphasize
import pickle
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_dir', default="./data/test/mix", type=str, help='test dir for clean')
    parser.add_argument('--enh_dir', default="./ae_enh", type=str, help='enhancement dir for noisy')
...
#Your statements here
    ...
    #print(model)
    #save_dir = "FPGA"
    checkpoint = torch.load('AE_SE_data_out_bs32/20201117_0804/checkpoints_AE_SE/AE_SE-250.pkl')
